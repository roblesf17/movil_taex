...
public class MyAdapterT extends RecyclerView.Adapter<MyAdapterT.MyViewHolder> implements Filterable {
    ...
    public MyAdapterT(Context c, ArrayList<Taller> t) {
        context = c;
        tallerarray = t;
        this.filterList = t;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.rowartistico, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setItemclicklistener(new itemclicklistener() {
            ...
            public void onItemClickListener(View v, int position) {
                ...
                Intent detalleTaller = new Intent(context, Detalle_ArtisticoActivity.class);

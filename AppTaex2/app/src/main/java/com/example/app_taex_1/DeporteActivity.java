...
public class DeporteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String titulo = "TALLERES DEPORTIVOS";
        ...
        recyclerView =(RecyclerView)findViewById(R.id.rv_deportivo);
    ...
    public void getDatos(){
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("TallerDeportivo");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new MyAdapterDeporte(DeporteActivity.this, list);
                recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DeporteActivity.this, "Opps.. Something is wrong", Toast.LENGTH_SHORT).show();

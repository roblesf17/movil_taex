...
public class MyAdapterDeporte extends RecyclerView.Adapter<MyAdapterDeporte.MyViewHolder> implements Filterable {

    Context context;
    ArrayList<Taller> tallerarray;
    ArrayList<Taller> filterList;

    CustomFilterD filter;
    public MyAdapterDeporte(Context c, ArrayList<Taller> t) {
        context = c;
        tallerarray = t;
        this.filterList = t;
    }
    ...
    public Filter getFilter() {
        ...
        if (filter == null){
            filter=new CustomFilterD(filterList,this);
        }
        return filter;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyAdapterDeporte.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.rowartistico, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setItemclicklistener(new itemclicklistener() {
            ...
            public void onItemClickListener(View v, int position) {
                ...
                Intent detalleTaller = new Intent(context, Detalle_DeporteActivity.class);

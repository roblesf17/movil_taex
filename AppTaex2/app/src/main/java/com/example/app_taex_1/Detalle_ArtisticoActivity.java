...
public class Detalle_ArtisticoActivity extends AppCompatActivity {
    ...
    String TipoTaller="Taller Artistico", TipoTaller2="TallerArtistico";
    String TallerId="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle__artistico);

        toolbar = (Toolbar) findViewById(R.id.toolbar);

        //Firebase
        database = FirebaseDatabase.getInstance();
        tallerdetalle=database.getReference("TallerArtistico");
        ...
        //buttonIncribirse=findViewById(R.id.btnIncribirseA);
        textViewMensaje=findViewById(R.id.txt_mensajeA);
        ...
        /**************** DESHABILITAR EL BOTON DE INSCRIBIRSE SI YA HIZO ESE TALLER ******************/
            /* final String codigo = Common.currentUser.codigo;
                    ...
                    if(dataSnapshot.exists()){
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            if(nombtaller.equals(currentTaller.getNombre_taller())){
                                ...
                                textViewMensaje.setText("Ya se ha inscrito a este curso anteriormente, no se puede inscribir de nuevo.");
                            }
                        ...
                        if(tallerestado.equals("Cerrado")){
                            buttonIncribirse.setVisibility(View.INVISIBLE);
                            textViewMensaje.setText("El taller ya se ha completado con la cantidad de alumnos requeridos. Inscribase en el siguiente semestre.");
                        }else
                        if (generotaller.equals("Femenino") && Common.currentUser.genero_alumno.equals("Masculino")){
                            buttonIncribirse.setVisibility(View.INVISIBLE);
                            textViewMensaje.setText("Existe un taller Masculino de este deporte.");
                        }else if(generotaller.equals("Masculino") && Common.currentUser.genero_alumno.equals("Femenino")){
                            buttonIncribirse.setVisibility(View.INVISIBLE);
                            textViewMensaje.setText("Existe un taller Femenino de este deporte.");
                        }
                    }
                }
        ...
        buttonIncribirse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nacimiento.isEmpty() || nacimiento.equals("") || direccion.equals("") || direccion.isEmpty() || celular.equals("") ||
                    ...
                    Toast.makeText(Detalle_ArtisticoActivity.this, "Complete sus datos en MI PERFIL para realizar la inscripcion ", Toast.LENGTH_LONG).show();
                }
                else if(canttaller>=2){
                    AlertDialog.Builder Confirm = new AlertDialog.Builder(Detalle_ArtisticoActivity.this);
                    Confirm.setMessage("Ya se ha inscrito a 2 talleres antes, no es necesario que se inscriba a otro. \n¿Desea continuar con la inscrpción?").setCancelable(false)
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent (Detalle_ArtisticoActivity.this, InscripcionActivity.class);
